...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center bg-white grid-bg pt-20 safari-fix">
      {/* Floating Images Container - z-index: 1 */}
      ...
      {/* Main Content Area - Protected Central Zone - z-index: 10 */}
      <div className="hero-content relative z-10 text-center px-4 sm:px-6 w-full max-w-[90vw] md:max-w-4xl lg:max-w-6xl mx-auto py-20 md:py-32">
        <motion.div
        ...
        >
          <div className="w-full">
            ...
            <h1 className="overflow-visible">
              <span className="text-[clamp(2.5rem,8vw,12rem)] font-adabelle font-medium tracking-tighter leading-[0.85] text-black uppercase italic mb-8 md:mb-16 block select-none">
                WORKFOLIO
              </span>
            </h1>
          </div>
      ...
      <div className="absolute bottom-32 left-8 md:hidden opacity-10 pointer-events-none z-[1]">
        <div className="w-16 h-16 border border-black/20 rounded-full animate-pulse" />
      </div>
      <div className="absolute top-32 right-8 md:hidden opacity-10 pointer-events-none z-[1]">
