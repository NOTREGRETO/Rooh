        ...
        >
          <div className="flex flex-col gap-6">
            <span className="text-[13px] font-black tracking-[0.5em] uppercase text-accent-pink/80 flex items-center gap-3">
             ...
             <h1 className="text-[58px] md:text-[92px] font-little-bean text-[#1A1A1A] leading-[0.9] tracking-tight">
            ...
            <div className="flex flex-wrap items-center gap-8 text-[15px] mt-6">
              <div className="flex items-center gap-3 px-5 py-2.5 bg-white/60 backdrop-blur-md rounded-full border border-white/60 shadow-sm">
                ...
                <span className="font-chalkboard text-[#1A1A1A]">Rooh Sidhu</span>
              </div>
              <span className="text-[#1A1A1A]/40 font-chalkboard tracking-wide">Jaipur, India</span>
              <div className="h-4 w-[1px] bg-[#1A1A1A]/10 hidden sm:block" />
              <span className="text-accent-pink/70 uppercase tracking-[0.25em] text-[12px] font-chalkboard">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          >
            <div className="bg-white/50 backdrop-blur-2xl p-12 md:p-20 rounded-[48px] border border-white shadow-[0_30px_60px_rgba(255,77,141,0.08)] relative overflow-hidden group w-full flex flex-col justify-between">
              ...
              <div className="absolute -top-10 -left-6 text-[240px] font-adabelle text-accent-pink opacity-[0.04] select-none pointer-events-none">"</div>
              ...
              <div className="relative">
                <div className="flex gap-8 mb-12">
                  ...
                  <p className="text-[32px] md:text-[42px] leading-[1.3] text-[#1A1A1A] font-adabelle italic tracking-tight font-medium">
                ...
                {stats.map((stat, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="text-[28px] font-chalkboard text-[#1A1A1A] leading-none">{stat.value}</span>
                      <span className="text-[12px] font-chalkboard uppercase tracking-[0.1em] text-accent-pink/60 mt-1.5">{stat.label}</span>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            >
              <h4 className="text-[14px] font-chalkboard uppercase tracking-[0.2em] text-[#1A1A1A]/40 mb-10 flex items-center gap-3">
              ...
              <div className="flex flex-col items-center justify-center flex-1 gap-5">
                ...
                <span className="text-[32px] font-chalkboard text-[#1A1A1A] tracking-tight">Canva</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                {creativeFields.map((field, i) => (
                  <span 
                    key={i} 
                    className="px-8 py-3 bg-white/80 border border-white rounded-full text-[16px] font-chalkboard text-accent-pink shadow-sm hover:bg-accent-pink hover:text-white hover:scale-105 transition-all duration-300 cursor-default"
                  >
                    {field}
                  </span>
                ))}
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {tags.map((tag, i) => (
                  <span 
                    key={i} 
                    className="px-5 py-2.5 bg-white/50 border border-white/50 rounded-2xl text-[14px] font-chalkboard text-[#1A1A1A]/60 hover:bg-white hover:text-accent-pink hover:scale-110 hover:shadow-lg transition-all duration-500 cursor-default"
                  >
                    #{tag}
                  </span>
                ))}
